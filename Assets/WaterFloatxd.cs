...
public class WaterFloatxd : MonoBehaviour
{
    //public properties
    ...
    {
        //get components
        Waves = FindObjectOfType<Wavesxd>();
        ...
        centerOffset = PhysicsHelperxd.GetCenter(WaterLinePoints) - transform.position;
    ...
    void FixedUpdate()
    {
        ...
        //compute up vector
        TargetUp = PhysicsHelperxd.GetNormal(WaterLinePoints);
